...
android {
    ...
    productFlavors {
        ...
        create("rustore") {
            dimension = "distribution"
            buildConfigField("String", "DISTRIBUTION", "\"RuStore\"")
    ...
    applicationVariants.all {
        ...
        val isRustore = variant.productFlavors.any { it.name == "rustore" }
        if (isFdroid) {
            val versionCodes =
                mapOf(
            ...
            variant.outputs
                ...
                .forEach { output ->
                    ...
                    val flavorTag = if (isRustore) "-rustore" else ""
                    output.outputFileName = "v2plus_${variant.versionName}${flavorTag}_${abi}.apk"
                    if (versionCodes.containsKey(abi)) {
                        output.versionCodeOverride =
