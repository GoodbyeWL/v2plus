...
import com.v2plus.app.databinding.ActivityRoutingSettingBinding
...
import com.v2plus.app.viewmodel.RoutingSettingsViewModel
                ...
                .setPositiveButton(android.R.string.ok) { _, _ ->
                    try {
                        lifecycleScope.launch(Dispatchers.IO) {
                            val ok = SettingsManager.resetRoutingRulesetsFromPresets(this@RoutingSettingActivity, i)
