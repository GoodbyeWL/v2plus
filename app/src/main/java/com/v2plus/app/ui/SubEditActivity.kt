...
import com.v2plus.app.databinding.ActivitySubEditBinding
...
class SubEditActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (editSubId == AppConfig.UNASSIGNED_SUBSCRIPTION_LIST_ID) {
            toast(R.string.sub_unassigned_cannot_edit)
            finish()
            return
        }
    ...
    private fun bindingServer(subItem: SubscriptionItem): Boolean {
        ...
        binding.etGroup.text = Utils.getEditable(subItem.group)
    ...
    private fun saveServer(): Boolean {
        ...
        subItem.group = binding.etGroup.text.toString()
                ...
                AlertDialog.Builder(this).setMessage(R.string.del_config_comfirm)
                    .setPositiveButton(android.R.string.ok) { _, _ ->
                        lifecycleScope.launch(Dispatchers.IO) {
                            ...
                            MessageUtil.sendMsg2UI(this@SubEditActivity, AppConfig.MSG_RELOAD_SERVER_LIST, "")
